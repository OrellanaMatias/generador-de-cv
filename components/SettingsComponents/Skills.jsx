                ...
                <motion.div layout="size" className=" mt-4">
                  ...
                  >
                    ...
                    <motion.input
                      layout
                      type="text"
                      className=" px-2 m-1 resize bg-blue-50 text-blue-900 placeholder:text-blue-600/40 focus:outline-none border-rose-100 focus:border-rose-500 border-2  rounded-lg w-32"
                      placeholder="+ Añadir"
